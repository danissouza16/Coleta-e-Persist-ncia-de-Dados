...
int main() {
    ...
    // Testando adicionar profissionais
    start = clock();
    addProf(prof, &count, "Daniel", "Dermatologista", &id1);
    addProf(prof, &count, "Fernando", "Cardiologista", &id2);
    addProf(prof, &count, "Luiza", "Cirurgião Geral", &id3);
    end = clock();
    printf("Tempo para adicionar profissional: %f segundos\n", (double)(end - start) / CLOCKS_PER_SEC);
    printf("\n");
    listProf(prof, count);

    // Testando ler um profissional
    start = clock();
    ...
    // Testando atualizar um profissional
    start = clock();
    ...
    // Testando excluir um profissional
    start = clock();
    ...
    // Salvando profissionais em arquivos de texto
    start = clock();
    ...
    // Carregando profissionais de arquivos de texto
    start = clock();
    ...
    // Salvando profissionais em arquivos binários
    start = clock();
    ...
    // Carregando profissionais de arquivos binários
    start = clock();
